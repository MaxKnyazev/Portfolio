...
В итоговой папке __app/css__ создаются три файла: __main.css__ - для стилей страницы, __global.css__ - для глобальных стилей, __vendor.css__ - для стилей всех библиотек, использующихся в проекте.
...
serg.knyazev77@gmail.com

git config user.name "MaxKnyazev"
git config user.email max.knyazev77@gmail.com
